...
I recently re-read [Nadia Eghbal'](https://twitter.com/nayafia)s ***[Working in Public: The Making and Maintenance of Open Source Software](https://press.stripe.com/working-in-public)*** because I'm funding the development of an [open-source project](https://tweetscape.co/) and really enjoyed [my first read](https://twitter.com/shingaithornton/status/1296479291677573120) back in 2020.
...
Ronald Coase's [theory of the firm](https://en.wikipedia.org/wiki/The_Nature_of_the_Firm) fails to explain the emergence of open-source software. Elinor Ostrom's [theory of the commons](https://en.wikipedia.org/wiki/Tragedy_of_the_commons) explains it well. [Commons-based peer production](https://en.wikipedia.org/wiki/Commons-based_peer_production) requires **intrinsic motivation, modular and granular tasks, and low coordination costs.**
