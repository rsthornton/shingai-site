---
title: "Notes on Baccalaureate Degrees in Systems Science"
permalink: "notes-on-baccalaureate-degrees-in-systems-science"
date: 2022-04-15
updated: 2023-02-19
---

[George Mobus](https://faculty.washington.edu/gmobus/vitae.html) and [Michael Kalton](https://directory.tacoma.uw.edu/employee/mkalton) have written a compelling argument for developing [Baccalaureate Degree programs in Systems Science](https://faculty.washington.edu/gmobus/Admin/SystemsScience/explainingSystemsScience.html). Here are my notes.
...
[Systems science](https://en.wikipedia.org/wiki/Systems_science) provides a methodology for using the systems approach reliably and rigorously. It is unique among the sciences in that its concepts can be applied to all other sciences.

## Systems Science Content

The key principles of systems science apply in every field of study. Some of these include:

1. Systems are made up of interacting components
2. Systems have boundaries
3. Systems exist within environments
4. Systems are composed of subsystems
5. Systems are embedded in larger systems
...
Efforts to develop [General System Theory](https://www.sciencedirect.com/topics/computer-science/general-system-theory) and create a legitimate full-fledged Systems Science in the mid 20th century failed due to our lack of understanding in areas such as non-linear dynamics and chaos theory. This is changing largely as a result of cheap and powerful computation.
