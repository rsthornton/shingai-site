...
[Hive.one](https://hive.one/) aims to solve this problem with an algorithmic approach.
...
Their [algorithm calculates influence ("attention") scores by](https://hivedotone.substack.com/p/algorithm-20-is-now-live) examining the Twitter follow graph.
...
All the platform's data can be accessed through their [API](https://www.notion.so/API-Docs-69fe2f3d624843fcb0b44658b135161b).
...
Hive.one has built [an automated model](https://borgcollective.notion.site/About-15b9db2c1f414cf998c5abc58b715176) that "can find communities of people and do it accurately enough to satisfy insiders." While the first version of the algorithm relied on a seed list of accounts to find communities, the [most recent update](https://hivedotone.substack.com/p/algorithm-v-21-is-now-live) allows it to find them based on a single word input.

Hive.one users can customize their experience by saving communities to their group of "[interests](https://hivedotone.substack.com/p/introducing-interests)." Selected interests are made public which enables other users to curate based on the interests of others, and allows developers to build on the open graph.
...
*[Hive.one: Introducing Interests](https://hivedotone.substack.com/p/introducing-interests)*
...
The [team has stated](https://borgcollective.notion.site/FAQ-5434e4695d60456cb481acb98bb88b18) they'll be indexing other platforms besides Twitter. New platforms will be added based on which ones are the most popular among the communities that use Hive.one most often.

## Example: Evaluating Hive.one's Ethereum Community

Let's examine the [Ethereum community](https://hive.one/c/ethereum?page=1) to see how Hive.one's algorithm performs at measuring influence and identifying community insiders.
...
The Hive.one team envisions a future where users can move with their reputation between social media platforms, Web3, and other apps. The final phase of their [roadmap](https://www.notion.so/Hive-one-Roadmap-712ae8262c854e10817c505d28d82f78) will see the launch of thousands of budding hives.
