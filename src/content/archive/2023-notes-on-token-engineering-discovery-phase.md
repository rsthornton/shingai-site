...
I recently finished the [second module](https://tokenengineering.net/course/tef-module2/) in Token Engineering Academy's TE Fundamentals series.
...
My [detailed notes from the course are here](https://www.notion.so/shingai/Notes-on-Token-Engineering-Process-Discovery-Phase-0cbf9621952e4e738f34e5765fa65b64). Here's a brief summary of the course content.
...
Tools like the [ecosystem design toolkit](https://github.com/villeeloranta/ecosystem-design-toolkit/blob/master/aalto_ecosystemdesigntoolkit_v01jan20_200122v1_ve.pdf) are helpful for determining stakeholders.

![](/images/archive/notes-on-token-engineering-discovery-phase/image.png)
*[Ecosystem Design Toolkit](https://github.com/villeeloranta/ecosystem-design-toolkit/blob/master/aalto_ecosystemdesigntoolkit_v01jan20_200122v1_ve.pdf)*
...
Next we need to figure out how to use these factors to trigger specific actions and behaviors we view as desirable. We can use the [Token Utility Canvas](https://outlierventures.io/wp-content/uploads/2021/06/Token-Ecosystem-Creation-Outlier-Ventures-PDF.pdf) to help design an incentive structure to ensure everyone is motivated to perform the actions their roles requires.

![](/images/archive/notes-on-token-engineering-discovery-phase/Screen-Shot-2023-01-31-at-9.46.26-AM.png)
*[Token Ecosystem Creation–Outlier Ventures (P.17)](https://outlierventures.io/wp-content/uploads/2021/06/Token-Ecosystem-Creation-Outlier-Ventures-PDF.pdf)*
